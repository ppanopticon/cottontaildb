...
/**
 * The [DirectHareDiskManager] facilitates reading and writing of [Page]s from/to the underlying HARE page file. Only one
 * [HareDiskManager] can be opened per HARE file and it acquires an exclusive [FileLock] once created.
 *
 * As opposed to other [HareDiskManager] implementations, the [DirectHareDiskManager] persistently writes all changes directly
